...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__WordCounts__ = __webpack_require__(466);
...
const hashWords = (txt) => {
  const wordCountsObj = new __WEBPACK_IMPORTED_MODULE_1__WordCounts__["a" /* default */];
  console.log("countsobj:", wordCountsObj);

  const words = splitText(txt);
  ...
  for (let i = 0; i < words.length; i++) {
    ...
    if (wordCountsObj.counts[word]) {
      wordCountsObj.counts[word]++;
    } else {
      wordCountsObj.counts[word] = 1;
    }

    // this function gets used to sort words by word count
  }
  const compareWordCounts = (word1, word2) => {
    if (wordCountsObj.counts[word1] > wordCountsObj.counts[word2]) {
      return -1;
    } else if (wordCountsObj.counts[word1] < wordCountsObj.counts[word2]) {
      return 1;
    } else {
      return 0;
    }
  ...
  Object.freeze(wordCountsObj);
  
  for (var word in wordCountsObj.counts) {
    if  (wordCountsObj.counts.hasOwnProperty(word) && !nonsenseWords.includes(word) && word.length >= minLength) {
      allWords.push(word);
    }
  }


  return [allWords.sort(compareWordCounts),wordCountsObj];
};
...
const loadAsText = (file) => {
  ...
  reader.onload = (loadedEvent) => {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__bubbles__["a" /* default */])(sorted[0], sorted[1]);
  };
...
//   sorted = hashWords(preloadedTexts["Dante"]);
//   runSimulation(sorted[0], sorted[1]);
// });

const loadKing = () => { 
  const sorte = hashWords(preloadedTexts["King"]);
  // console.log("sorted");
  // console.log(sorted);
  Object(__WEBPACK_IMPORTED_MODULE_0__bubbles__["a" /* default */])(sorte[0], sorte[1]);
};

const loadShakespeare = () => {
  const sortee = hashWords(preloadedTexts["Shakespeare"]);
  console.log("array before bubbles: ", sortee[0]);
  console.log("object before bubbles: ", sortee[1]);
  Object(__WEBPACK_IMPORTED_MODULE_0__bubbles__["a" /* default */])(sortee[0], sortee[1]);
};

const loadDante = () => {
  const sortedd = hashWords(preloadedTexts["Dante"]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_dispatch__ = __webpack_require__(16);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_d3_dispatch__ = __webpack_require__(16);
/* unused harmony namespace reexport */
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_11_d3_force__["a"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_11_d3_force__["b"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_11_d3_force__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_11_d3_force__["d"]; });
...
/* harmony default export */ __webpack_exports__["a"] = (WordCounts);
